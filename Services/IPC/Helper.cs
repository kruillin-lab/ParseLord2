...
using ParseLord2.API.Extension;
...
public partial class Helper(ref Leasing leasing)
{
        ...
        string additionalInfo = "")
    {
        ...
        {
            PrefixForIPC = prefix;
            LeaseeIPC.ParseLord2Callback((int)reason, additionalInfo);
            LeaseeIPC.Dispose();
        }
        catch
        {
    ...
    private const string IPCStatusEndpoint =
        "https://raw.githubusercontent.com/PunishXIV/ParseLord2/main/res/ipc_status.txt";
...
{
    private const string Prefix = "[ParseLord2 IPC] ";
...
#pragma warning disable CS0649, CS8618 // Complaints of the method
    [EzIPC] internal static readonly Action<int, string> ParseLord2Callback;
