...
public partial class ParseLord2
{
    private const string Command = "/parselord2";
    private const string ShortCommand = "/pl2";
    private const string LegacyCommand = "/wrath";
    ...
    private void HandleAutoCommands(string[] argument)
    {
        ...
        if (argument.Length >= 4 && argument[1] == "target")
        {
            ...
            switch (role)
            {
                ...
                default:
                    DuoLog.Error("Usage: /parselord2 auto target <damage|healer> <mode>");
                    return;
            }
        }
