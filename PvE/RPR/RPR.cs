...
internal partial class RPR : Melee
{
    internal class RPR_ST_SimpleMode : CustomCombo
    {
        ...
        protected override uint Invoke(uint actionID)
        {
            ...
            //Plentiful Harvest
            // Meta: Plentiful Harvest becomes usable AFTER Bloodsown Circle expires.
            // Use it whenever we have any Immortal Sacrifice stacks and are not currently in a special combo state.
            if (!HasStatusEffect(Buffs.Enshrouded) && !HasStatusEffect(Buffs.SoulReaver) &&
                !HasStatusEffect(Buffs.Executioner) && HasStatusEffect(Buffs.ImmortalSacrifice) &&
                !HasStatusEffect(Buffs.BloodsownCircle) && !JustUsed(PlentifulHarvest))
