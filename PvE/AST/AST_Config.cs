...
using static ParseLord2.Window.Functions.SliderIncrements;
...
internal partial class AST
{
    public static class Config
    {
        ...
        public static UserInt
            ...
            AST_ST_SimpleHeals_AspectedBeneficKeepOnTankHPThreshold = new("AST_ST_SimpleHeals_AspectedBeneficKeepOnTankHPThreshold", 90),
        ...
        public static UserBool
            ...
            AST_ST_SimpleHeals_AspectedBeneficKeepOnTank = new("AST_ST_SimpleHeals_AspectedBeneficKeepOnTank"),
        ...
        internal static void Draw(Preset preset)
        {
            switch (preset)
            {
                ...
                case Preset.AST_ST_Heals_AspectedBenefic:
                    ...
                    DrawAdditionalBoolChoice(AST_ST_SimpleHeals_AspectedBeneficKeepOnTank,
                        $"Keep {AspectedBenefic.ActionName()} on tanks below a threshold",
                        "When enabled, keeps Aspected Benefic refreshed on party tanks while their HP% is below the configured threshold.");
                    if (AST_ST_SimpleHeals_AspectedBeneficKeepOnTank)
                        DrawSliderInt(1, 100, AST_ST_SimpleHeals_AspectedBeneficKeepOnTankHPThreshold,
                            "Tank HP% threshold for maintaining Aspected Benefic (default 90%).");
