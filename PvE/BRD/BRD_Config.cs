...
internal partial class BRD
{
    internal static class Config
    {
        ...
        public static UserBool
            ...
            BRD_Adv_Debug = new("BRD_Adv_Debug");
        ...
        internal static void Draw(Preset preset)
        {
            switch (preset)
            {
                ...
                case Preset.BRD_ST_Adv_Balance_Standard:
                    DrawAdditionalBoolChoice(BRD_Adv_Debug, "Advanced Debug Trace", "Logs BRD Advanced decisions (songs / DoTs / buffs) to PluginLog for troubleshooting.", indentDescription: true);
